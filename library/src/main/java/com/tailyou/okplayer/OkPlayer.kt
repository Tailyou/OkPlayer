...
object OkPlayer {
    ...
    fun registerPlayReceiver(context: Context, playReceiver: PlayReceiver) {
        ...
        filter.addAction(Constants.ACTION_S_2_A_PRG)
        filter.addAction(Constants.ACTION_S_2_A_STATUS)
        filter.addAction(Constants.ACTION_INCOMMING_CALL)
    ...
    fun notifyNewMp3(context: Context, mp3Url: String) {
        var newMp3 = Intent(Constants.ACTION_A_2_S_MP3)
    ...
    fun notifyPlay(context: Context) {
        var playCtrl = Intent(Constants.ACTION_A_2_S_CTRL)
    ...
    fun notifyProgress(context: Context, progress: Int) {
        var intentPrg = Intent(Constants.ACTION_A_2_S_PRG)
