...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        const val PERMISSION_ACCESS_STORAGE = 102
    }
    ...
    @AfterPermissionGranted(PERMISSION_ACCESS_STORAGE)
    private fun playMp3() {
        if (EasyPermissions.hasPermissions(this, *perms)) {
            ...
            EasyPermissions.requestPermissions(this, "请授予存储访问权限", PERMISSION_ACCESS_STORAGE, *perms)
        }
    }
